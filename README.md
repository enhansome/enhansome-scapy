...
* [pwnagotchi](https://github.com/evilsocket/pwnagotchi) ⭐ 9,175 | 🐛 294 | 🌐 Python | 📅 2025-08-23 - Your AI pet that hacks WiFI to grow. It's super cute.

DDoS

* [ufonet](https://github.com/epsylon/ufonet) ⭐ 2,504 | 🐛 0 | 🌐 Python | 📅 2026-05-28 - Create your own botnet to send untraceable DDoS attacks.

Wi-Fi.

* [wifiphisher](https://github.com/wifiphisher/wifiphisher) ⭐ 14,774 | 🐛 353 | 🌐 Python | 📅 2026-05-22 - Create rogue access point.
* [trackerjacker](https://github.com/calebmadrigal/trackerjacker) ⭐ 2,741 | 🐛 18 | 🌐 Python | 📅 2026-03-22 - Maps and tracks Wi-Fi networks and devices through raw 802.11 monitoring.

Wireless

* [WHAD](https://github.com/whad-team/whad-client) ⭐ 326 | 🐛 73 | 🌐 Python | 📅 2026-06-18 - A powerful framework to perform various kinds of Wireless attacks.

IPv6

* [mitm6](https://github.com/fox-it/mitm6) ⭐ 1,917 | 🐛 17 | 🌐 Python | 📅 2024-02-20 - Performs MiTM for IPv6.
...
* [Linux Kernel](https://github.com/torvalds/linux/blob/master/tools/testing/selftests/tc-testing/plugin-lib/scapyPlugin.py) ⭐ 243,204 | 🐛 3 | 🌐 C | 📅 2026-08-18 - Linux Traffic Control (tc) testing suite.
* [RIOT-OS](https://github.com/RIOT-OS/RIOT/search?l=Python\&q=scapy\&type=Code) ⭐ 5,777 | 🐛 866 | 🌐 C | 📅 2026-08-18 - RIOT OS networking testing suite.
...
* [net-creds](https://github.com/DanMcInerney/net-creds) ⭐ 1,855 | 🐛 8 | 🌐 Python | 📅 2023-11-02 - Sniff and catch all sensitive data on an interface.
* [Habu](https://github.com/fportantier/habu) ⭐ 983 | 🐛 3 | 🌐 Python | 📅 2025-12-30 - Toolkit with a lot of little hacking tools. Many of them use Scapy.
* [pysap](https://github.com/SecureAuthCorp/pysap) ⭐ 256 | 🐛 4 | 🌐 Python | 📅 2026-08-08 - Interact with SAP using custom built frames & tools.
* [fenrir](https://github.com/Orange-Cyberdefense/fenrir-ocd) ⭐ 240 | 🐛 7 | 🌐 Python | 📅 2020-10-08 - Bypass wired 802.1x protection.
* [h2spacex](https://github.com/nxenon/h2spacex) ⭐ 227 | 🐛 0 | 🌐 Python | 📅 2026-06-14 - HTTP/2 low level library based on Scapy which can be used for Single Packet Attack (Race Condition on H2).
...
* [sshame](https://github.com/HynekPetrak/sshame) ⭐ 79 | 🐛 2 | 🌐 Python | 📅 2025-06-02 - Tool to brute force SSH public-key authentication.
...
* [PPPwn (CVE-2006-4304)](https://github.com/TheOfficialFloW/PPPwn) ⭐ 2,958 | 🐛 12 | 🌐 Python | 📅 2024-06-16 - Playstation 4 PPPoE RCE.
...
* [fragattacks](https://github.com/vanhoefm/fragattacks) ⭐ 1,309 | 🐛 3 | 🌐 C | 📅 2025-04-29 - Fragmentation & Aggregation Attacks.
...
* [krackattacks-scripts](https://github.com/vanhoefm/krackattacks-scripts) ⭐ 3,523 | 🐛 5 | 🌐 C | 📅 2024-12-25 - Test if clients or access points (APs) are affected by the KRACK attack against WPA2.
