...
* [wifiphisher](https://github.com/wifiphisher/wifiphisher) ⭐ 14,825 | 🐛 353 | 🌐 Python | 📅 2026-05-22 - Create rogue access point.
...
* [Linux Kernel](https://github.com/torvalds/linux/blob/master/tools/testing/selftests/tc-testing/plugin-lib/scapyPlugin.py) ⭐ 247,404 | 🐛 3 | 🌐 C | 📅 2026-09-07 - Linux Traffic Control (tc) testing suite.
* [RIOT-OS](https://github.com/RIOT-OS/RIOT/search?l=Python\&q=scapy\&type=Code) ⭐ 5,785 | 🐛 871 | 🌐 C | 📅 2026-09-07 - RIOT OS networking testing suite.
...
* [pysap](https://github.com/SecureAuthCorp/pysap) ⭐ 256 | 🐛 4 | 🌐 Python | 📅 2026-09-07 - Interact with SAP using custom built frames & tools.
