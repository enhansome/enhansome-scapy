...
* [pwnagotchi](https://github.com/evilsocket/pwnagotchi) ⭐ 9,193 | 🐛 294 | 🌐 Python | 📅 2026-08-19 - Your AI pet that hacks WiFI to grow. It's super cute.

DDoS

* [ufonet](https://github.com/epsylon/ufonet) ⭐ 2,513 | 🐛 0 | 🌐 Python | 📅 2026-05-28 - Create your own botnet to send untraceable DDoS attacks.

Wi-Fi.

* [wifiphisher](https://github.com/wifiphisher/wifiphisher) ⭐ 14,797 | 🐛 353 | 🌐 Python | 📅 2026-05-22 - Create rogue access point.
...
* [WHAD](https://github.com/whad-team/whad-client) ⭐ 329 | 🐛 72 | 🌐 Python | 📅 2026-06-18 - A powerful framework to perform various kinds of Wireless attacks.
...
* [Linux Kernel](https://github.com/torvalds/linux/blob/master/tools/testing/selftests/tc-testing/plugin-lib/scapyPlugin.py) ⭐ 245,202 | 🐛 3 | 🌐 C | 📅 2026-08-29 - Linux Traffic Control (tc) testing suite.
* [RIOT-OS](https://github.com/RIOT-OS/RIOT/search?l=Python\&q=scapy\&type=Code) ⭐ 5,780 | 🐛 873 | 🌐 C | 📅 2026-08-29 - RIOT OS networking testing suite.
...
* [net-creds](https://github.com/DanMcInerney/net-creds) ⭐ 1,861 | 🐛 8 | 🌐 Python | 📅 2023-11-02 - Sniff and catch all sensitive data on an interface.
...
* [pysap](https://github.com/SecureAuthCorp/pysap) ⭐ 256 | 🐛 4 | 🌐 Python | 📅 2026-08-28 - Interact with SAP using custom built frames & tools.
...
* [PPPwn (CVE-2006-4304)](https://github.com/TheOfficialFloW/PPPwn) ⭐ 2,960 | 🐛 12 | 🌐 Python | 📅 2024-06-16 - Playstation 4 PPPoE RCE.
...
* [fragattacks](https://github.com/vanhoefm/fragattacks) ⭐ 1,312 | 🐛 3 | 🌐 C | 📅 2025-04-29 - Fragmentation & Aggregation Attacks.
...
* [krackattacks-scripts](https://github.com/vanhoefm/krackattacks-scripts) ⭐ 3,527 | 🐛 5 | 🌐 C | 📅 2024-12-25 - Test if clients or access points (APs) are affected by the KRACK attack against WPA2.
