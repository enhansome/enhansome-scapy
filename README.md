...
* [wifiphisher](https://github.com/wifiphisher/wifiphisher) ⭐ 14,807 | 🐛 353 | 🌐 Python | 📅 2026-05-22 - Create rogue access point.
...
* [Linux Kernel](https://github.com/torvalds/linux/blob/master/tools/testing/selftests/tc-testing/plugin-lib/scapyPlugin.py) ⭐ 245,482 | 🐛 3 | 🌐 C | 📅 2026-08-31 - Linux Traffic Control (tc) testing suite.
* [RIOT-OS](https://github.com/RIOT-OS/RIOT/search?l=Python\&q=scapy\&type=Code) ⭐ 5,782 | 🐛 878 | 🌐 C | 📅 2026-08-31 - RIOT OS networking testing suite.
...
* [Habu](https://github.com/fportantier/habu) ⭐ 984 | 🐛 3 | 🌐 Python | 📅 2025-12-30 - Toolkit with a lot of little hacking tools. Many of them use Scapy.
...
* [h2spacex](https://github.com/nxenon/h2spacex) ⭐ 228 | 🐛 0 | 🌐 Python | 📅 2026-06-14 - HTTP/2 low level library based on Scapy which can be used for Single Packet Attack (Race Condition on H2).
...
* [krackattacks-scripts](https://github.com/vanhoefm/krackattacks-scripts) ⭐ 3,529 | 🐛 5 | 🌐 C | 📅 2024-12-25 - Test if clients or access points (APs) are affected by the KRACK attack against WPA2.
