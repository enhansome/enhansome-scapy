...
* [pwnagotchi](https://github.com/evilsocket/pwnagotchi) ⭐ 9,169 | 🐛 294 | 🌐 Python | 📅 2025-08-23 - Your AI pet that hacks WiFI to grow. It's super cute.
...
* [wifiphisher](https://github.com/wifiphisher/wifiphisher) ⭐ 14,767 | 🐛 353 | 🌐 Python | 📅 2026-05-22 - Create rogue access point.
...
* [mitm6](https://github.com/fox-it/mitm6) ⭐ 1,915 | 🐛 17 | 🌐 Python | 📅 2024-02-20 - Performs MiTM for IPv6.
...
* [Linux Kernel](https://github.com/torvalds/linux/blob/master/tools/testing/selftests/tc-testing/plugin-lib/scapyPlugin.py) ⭐ 242,752 | 🐛 3 | 🌐 C | 📅 2026-08-13 - Linux Traffic Control (tc) testing suite.
* [RIOT-OS](https://github.com/RIOT-OS/RIOT/search?l=Python\&q=scapy\&type=Code) ⭐ 5,777 | 🐛 866 | 🌐 C | 📅 2026-08-13 - RIOT OS networking testing suite.
...
* [net-creds](https://github.com/DanMcInerney/net-creds) ⭐ 1,854 | 🐛 8 | 🌐 Python | 📅 2023-11-02 - Sniff and catch all sensitive data on an interface.
...
* [fragattacks](https://github.com/vanhoefm/fragattacks) ⭐ 1,308 | 🐛 3 | 🌐 C | 📅 2025-04-29 - Fragmentation & Aggregation Attacks.
