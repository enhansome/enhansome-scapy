...
* [pwnagotchi](https://github.com/evilsocket/pwnagotchi) ⭐ 9,178 | 🐛 294 | 🌐 Python | 📅 2026-08-19 - Your AI pet that hacks WiFI to grow. It's super cute.

DDoS

* [ufonet](https://github.com/epsylon/ufonet) ⭐ 2,505 | 🐛 0 | 🌐 Python | 📅 2026-05-28 - Create your own botnet to send untraceable DDoS attacks.

Wi-Fi.

* [wifiphisher](https://github.com/wifiphisher/wifiphisher) ⭐ 14,777 | 🐛 353 | 🌐 Python | 📅 2026-05-22 - Create rogue access point.
...
* [WHAD](https://github.com/whad-team/whad-client) ⭐ 327 | 🐛 73 | 🌐 Python | 📅 2026-06-18 - A powerful framework to perform various kinds of Wireless attacks.
...
* [Linux Kernel](https://github.com/torvalds/linux/blob/master/tools/testing/selftests/tc-testing/plugin-lib/scapyPlugin.py) ⭐ 243,430 | 🐛 3 | 🌐 C | 📅 2026-08-20 - Linux Traffic Control (tc) testing suite.
* [RIOT-OS](https://github.com/RIOT-OS/RIOT/search?l=Python\&q=scapy\&type=Code) ⭐ 5,776 | 🐛 861 | 🌐 C | 📅 2026-08-20 - RIOT OS networking testing suite.
...
* [pysap](https://github.com/SecureAuthCorp/pysap) ⭐ 256 | 🐛 4 | 🌐 Python | 📅 2026-08-20 - Interact with SAP using custom built frames & tools.
