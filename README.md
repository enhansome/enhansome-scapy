...
* [pwnagotchi](https://github.com/evilsocket/pwnagotchi) ⭐ 9,171 | 🐛 294 | 🌐 Python | 📅 2025-08-23 - Your AI pet that hacks WiFI to grow. It's super cute.

DDoS

* [ufonet](https://github.com/epsylon/ufonet) ⭐ 2,501 | 🐛 0 | 🌐 Python | 📅 2026-05-28 - Create your own botnet to send untraceable DDoS attacks.

Wi-Fi.

* [wifiphisher](https://github.com/wifiphisher/wifiphisher) ⭐ 14,769 | 🐛 353 | 🌐 Python | 📅 2026-05-22 - Create rogue access point.
...
* [WHAD](https://github.com/whad-team/whad-client) ⭐ 325 | 🐛 73 | 🌐 Python | 📅 2026-06-18 - A powerful framework to perform various kinds of Wireless attacks.

IPv6

* [mitm6](https://github.com/fox-it/mitm6) ⭐ 1,916 | 🐛 17 | 🌐 Python | 📅 2024-02-20 - Performs MiTM for IPv6.
...
* [Linux Kernel](https://github.com/torvalds/linux/blob/master/tools/testing/selftests/tc-testing/plugin-lib/scapyPlugin.py) ⭐ 242,833 | 🐛 3 | 🌐 C | 📅 2026-08-14 - Linux Traffic Control (tc) testing suite.
* [RIOT-OS](https://github.com/RIOT-OS/RIOT/search?l=Python\&q=scapy\&type=Code) ⭐ 5,777 | 🐛 867 | 🌐 C | 📅 2026-08-14 - RIOT OS networking testing suite.
...
* [PPPwn (CVE-2006-4304)](https://github.com/TheOfficialFloW/PPPwn) ⭐ 2,959 | 🐛 12 | 🌐 Python | 📅 2024-06-16 - Playstation 4 PPPoE RCE.
...
* [krackattacks-scripts](https://github.com/vanhoefm/krackattacks-scripts) ⭐ 3,522 | 🐛 5 | 🌐 C | 📅 2024-12-25 - Test if clients or access points (APs) are affected by the KRACK attack against WPA2.
